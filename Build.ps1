...
# Edit $NeosDir to be the path to the neos directory on your own system //  "-DontAutoOpenCloudHome", "-Screen", 
...
$NeosProc = Start-Process -FilePath $NeosExe -WorkingDirectory $NeosDir -ArgumentList "-SkipIntroTutorial", "-LoadAssembly `"D:\Games\Neos\app\Libraries\NeosModLoader.dll`"" -passthru
